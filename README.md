...
> 一个融入桌面的 AI 助手——状态融入壁纸，交互交给助手，编辑留给面板。
...
| 层 | 做什么 | 不做什么 |
|----|--------|---------|
| **壁纸层** | 天气、时间、任务进度、专注计时——回到桌面一瞥即知 | 不交互、不点击、不弹窗 |
...
专注计时圆环、未完成任务、天气时间、助手寄语、氛围色调——全部融入壁纸背景。纯展示、零打扰、回到桌面即可感知。
...
桌面常驻悬浮助手的基本 2D 精灵图形态、语音 TTS 播报。助手番茄钟、待办、天气碎碎念。壁纸层 MVP（天气时间 + 专注计时圆环）。Hook 角标通知。
